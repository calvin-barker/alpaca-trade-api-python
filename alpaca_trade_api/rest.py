...
class REST(object):
    ...
    def submit_order(self,
        ...
        if not (qty and notational) or (not qty and not notational):
            raise ValueError("Exactly one of either `qty` or `notational` must be stated")
        ...
        if qty:
            ...
            params["notational"] = notational
            # docs say only market orders are supported at this time
            # todo: update to reflect this: https://alpaca.markets/learn/fractional-shares-api/
            params["type"] = "market"
